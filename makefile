prototype: gen/temp/Curfew_Amsterdam.csv gen/temp/datacompl.csv data/data_downloaded.txt gen/paper/avgprice.pdf gen/paper/price_superhost.pdf gen/paper/stargazer.htm
