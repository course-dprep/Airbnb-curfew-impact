...
## Resources
If someone is looking for more information about other variables that influence Airbnb pricing we reccomend the following article:
...
Next couple articles discuss host status in more detail and the effect it has on pricing, which might be interesting since we found a negative effect for superhost status on Airbnb listing prices:
